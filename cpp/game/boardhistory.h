...
struct BoardHistory {
  ...
  void makeBoardMoveAssumeLegal(Board& board, Loc fromLoc, Loc toLoc, Player movePla, const KoHashTable* rootKoHashTable);
  void makeBoardMoveAssumeLegal(Board& board, Loc fromLoc, Loc toLoc, Player movePla, const KoHashTable* rootKoHashTable, bool preventEncore);
